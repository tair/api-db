...
public class PageView extends AbstractPageView {
  ...
  /**
   * <p>
   * Create a PageView as a new object. This constructor calls the abstract 
  ...
  /**
   * <p>
   * Create a PageView. This constructor calls the abstract superclass 
   * constructor.
   * </p>
   *
...
processing the page views
   ...
   */
  public PageView(IPrimaryKey key, java.math.BigInteger pageViewId, java.sql.Timestamp pageViewDate, java.lang.String uri, java.lang.String ip, java.lang.String sessionId, java.math.BigInteger partyId) {
