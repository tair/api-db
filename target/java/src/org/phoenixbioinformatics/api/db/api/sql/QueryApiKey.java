...
/**
 * <p>
 * A single-object query of a ApiKey using its primary key. This class
 * is the concrete subclass of the generated abstract class AbstractQueryApiKey. 
 ...
 * single ApiKey object from the database.
 * </p>
${dto.getDocumentation}
 * 
 * @author Poesys/DB Cartridge
 */
public class QueryApiKey extends AbstractQueryApiKey {
}