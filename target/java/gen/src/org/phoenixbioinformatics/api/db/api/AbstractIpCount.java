 ...
 */
public abstract class AbstractIpCount extends AbstractDto implements IIpCount {
  ...
  /**
   * Create an empty IpCount for use in building a new object. The 
   * concrete subclass must call this constructor.
   */
  public AbstractIpCount() {
    abstractClass = false;
    createInserters();
  ...
  /**
   * Create a IpCount. The concrete subclass must call this constructor.
   *
  ...
  public AbstractIpCount(IPrimaryKey key, java.math.BigInteger partnerId, java.lang.String ip, java.lang.Integer count) {
    ...
    if (count == null) {
      throw new com.poesys.db.InvalidParametersException("count is required for " + key.getValueList());
    }
  ...
  /**
   * Clear the count data member; override in proxy if lazily loaded,
   * otherwise this method does nothing.
   */
   ...
   * </p>
   *
   * @param count the value with which to set the property
   * @throws com.poesys.db.InvalidParametersException when the input count is null
   */
  public void setCount(java.lang.Integer count)
      throws com.poesys.db.InvalidParametersException {
    if (count == null) {
      throw new com.poesys.db.InvalidParametersException("count is required");
    }
  ...
  /**
   * Create the inserters for the IpCount and its superclasses.
   */
  private void createInserters() {
    com.poesys.db.dao.IDaoManager manager =
      com.poesys.db.dao.DaoManagerFactory.getManager(getSubsystem());
    final com.poesys.db.dao.IDaoFactory<org.phoenixbioinformatics.api.db.api.IIpCount> ipCountFactory =
      manager.getFactory("org.phoenixbioinformatics.api.db.api.IpCount",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<IIpCount> sql =
      new org.phoenixbioinformatics.api.db.api.sql.InsertIpCount();
    com.poesys.db.dao.insert.IInsert<IIpCount> inserter =
      ipCountFactory.getInsert(sql, true);
