...
CREATE SEQUENCE Partner_SEQ NOCACHE;
...
VALUES (Partner_SEQ.nextval, 'TAIR', 'https://www.arabidopsis.org/i/logo2.gif', 'https://www.arabidopsis.org/doc/about/tair_terms_of_use/417');
...
FOREIGN KEY (header, partnerId) REFERENCES SubscriptionDescription(header, partnerId) ON DELETE CASCADE;
...
CREATE TABLE ActivationCode (
  ...
  partnerId NUMBER(38) NOT NULL,  
  CONSTRAINT ActivationCodePK PRIMARY KEY (activationCode)
);
...
CREATE TABLE Subscription (
  ...
  subscriptionId NUMBER(18) NOT NULL,  -- generated by sequence
...
FOREIGN KEY (activationCode) REFERENCES ActivationCode(activationCode) ON DELETE CASCADE;
