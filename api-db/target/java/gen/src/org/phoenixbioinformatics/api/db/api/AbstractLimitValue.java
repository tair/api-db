 ...
 */
public abstract class AbstractLimitValue extends AbstractDto implements ILimitValue {
  ...
  /**
   * Create an empty LimitValue for use in building a new object. The 
   * concrete subclass must call this constructor.
   */
  public AbstractLimitValue() {
    abstractClass = false;
    createInserters();
  ...
  /**
   * Create a LimitValue. The concrete subclass must call this constructor.
   *
  ...
  public AbstractLimitValue(IPrimaryKey key, java.lang.String partnerId, java.lang.Integer value) {
    ...
    if (value == null) {
      throw new com.poesys.db.InvalidParametersException("value is required for " + key.getValueList());
    }
  ...
  public boolean equals(Object arg0) {
    ILimitValue other = (ILimitValue)arg0;
  ...
  public int compareTo(com.poesys.db.dto.IDbDto o) {
    ILimitValue other = (ILimitValue)o;
  ...
  /**
   * Clear the value data member; override in proxy if lazily loaded,
   * otherwise this method does nothing.
   */
  ...
  /**
   * Create the inserters for the LimitValue and its superclasses.
   */
  private void createInserters() {
    com.poesys.db.dao.IDaoManager manager =
      com.poesys.db.dao.DaoManagerFactory.getManager(getSubsystem());
    final com.poesys.db.dao.IDaoFactory<org.phoenixbioinformatics.api.db.api.ILimitValue> limitValueFactory =
      manager.getFactory("org.phoenixbioinformatics.api.db.api.LimitValue",
                         getSubsystem(),
                         2147483647);
    com.poesys.db.dao.insert.IInsertSql<ILimitValue> sql =
      new org.phoenixbioinformatics.api.db.api.sql.InsertLimitValue();
    com.poesys.db.dao.insert.IInsert<ILimitValue> inserter =
      limitValueFactory.getInsert(sql, true);
